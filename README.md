...
Clique em Open with Live Server no arquivo index.html.
...
h1 a h3 – Estruturam títulos e subtítulos da interface.
...
A cada 3 segundos, todos os valores do dashboard se atualizam automaticamente:

Oxigênio, Água, Alimentos, Autonomia, Temperatura, Pressão, Umidade e CO₂.

Os números mudam de cor conforme o nível:
...
Clicar novamente para parar a simulação.

🚨 Botão "Emergência"

Onde:

Painel de Controle, ao lado do botão de simulação.

O que acontece:

Abre uma janela confirm() do navegador perguntando se deseja notificar a base terrestre.
...
Clicar novamente restaura o estado normal.

📡 Botão "Comunicação (60s)"

Onde:

Painel de Controle, ao lado do botão de emergência.
...
Seção "Relatórios", no final da página.
...
setTimeout – Delay de comunicação, cronômetro e processamento do formulário.
...
if / else – Classifica o nível de alerta de cada recurso.
